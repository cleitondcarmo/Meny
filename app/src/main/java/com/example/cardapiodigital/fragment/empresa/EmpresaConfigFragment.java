...
import com.example.cardapiodigital.activity.empresa.EmpresaQRcodeActivity;
import com.example.cardapiodigital.activity.empresa.EmpresaCategoriasActivity;
import com.example.cardapiodigital.activity.empresa.EmpresaConfigActivity;
...
public class EmpresaConfigFragment extends Fragment {
    ...
    private void configCliques(){
        ...
        menu_add_mais.setOnClickListener(v -> startActivity(new Intent(requireActivity(), EmpresaQRcodeActivity.class)));
